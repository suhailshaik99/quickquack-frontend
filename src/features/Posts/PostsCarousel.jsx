...
//   // Get the carousel state and posts from Redux
//   const { carouselPostId, carouselPosts: posts } = useSelector((state) => state.post);
...
//         <div className="relative flex h-1/2 flex-col bg-sky-300 md:h-full">
...
//               </ul>
//             ) : (
//               <p className="mt-72 text-center text-2xl text-gray-500">
//                 No comments yet.
//               </p>
//             )}
//           </div>
...
//             onClick={handlePrev}
//             className={clsx(
//               "absolute left-2 top-1/2 z-10 -translate-y-1/2 transform rounded-full bg-white p-2 shadow-md hover:bg-gray-200",
//             )}
//           >
...
//             onClick={handleNext}
//             className={clsx(
//               "absolute right-2 top-1/2 z-10 -translate-y-1/2 transform rounded-full bg-white p-2 shadow-md hover:bg-gray-200",
//             )}
//           >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-3 backdrop-blur-sm">
      <div className="relative flex h-[85vh] w-full max-w-6xl flex-col overflow-hidden rounded-xl bg-white shadow-lg md:grid md:h-[80vh] md:grid-cols-2">
        ...
        {/* Right: Comments Section with CommentBox */}
        {/* ---- FIX HIGHLIGHT ---- */}
        {/* Added 'md:overflow-hidden' to force the grid cell to contain its children, fixing the desktop layout. */}
